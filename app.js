(function () {
  ...
  async function confirmTx(sig) {
    var info = await connection.getLatestBlockhash();
    return connection.confirmTransaction({ signature: sig, blockhash: info.blockhash, lastValidBlockHeight: info.lastValidBlockHeight });
  }
